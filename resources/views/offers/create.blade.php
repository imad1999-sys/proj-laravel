            ...
            <div class="content">
                ...
                <form method="POST" action="{{route('offers.store')}}">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="font-family: 'Baloo Tammudu 2', cursive;">Offer Name</label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1" style="font-family: 'Baloo Tammudu 2', cursive;">Offer Price</label>
                        <input type="text" class="form-control" name="price" placeholder="Enter the Price" style="font-family: 'Baloo Tammudu 2', cursive;">
                        @error('price')
                        <small class="form-text text-danger" style="font-family: 'Baloo Tammudu 2', cursive;">{{$message}}</small>
                        @enderror
                    </div>
                    <button type="submit" class="btn btn-primary" style="font-family: 'Baloo Tammudu 2', cursive;">Store Offer</button>
                </form>
            </div>
        </div>
