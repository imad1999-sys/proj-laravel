    ...
    <div class="container">
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                @endif
                <br>
                <form method="POST" action="" id="offerFormUpdate" name="offerForm" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="font-family: 'Baloo Tammudu 2', cursive;">{{__('messages.offerPhoto')}}</label>
                        <input type="file" class="form-control" name="photo" value="{{$offer -> photo}}" id="photo">
                        @error('photo')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{$offer -> name}}" id="name" placeholder="Enter the Name" style="font-family: 'Baloo Tammudu 2', cursive;">
                        @error('name')
                        <small class="form-text text-danger" style="font-family: 'Baloo Tammudu 2', cursive;">{{$message}}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="price" value="{{$offer -> price}}" id="price" placeholder="Enter the Price" style="font-family: 'Baloo Tammudu 2', cursive;">
                        @error('price')
                        <small class="form-text text-danger" style="font-family: 'Baloo Tammudu 2', cursive;">{{$message}}</small>
                        @enderror
                    </div>
                    <button id="updateOffer" type="submit" class="btn btn-primary" style="font-family: 'Baloo Tammudu 2', cursive;">{{__('messages.storeOffer')}}</button>
